...
public class BoundaryLocation {
    ...
    public MarkerAnchor markerAnchor;
     static final MarkerAnchor ANCHOR_TOP = new MarkerAnchor(0.5f, 0f);
    static final MarkerAnchor ANCHOR_TOP_LEFT = new MarkerAnchor(0f, 0f);
    static final MarkerAnchor ANCHOR_TOP_RIGHT = new MarkerAnchor(1f, 0f);
    static final MarkerAnchor ANCHOR_RIGHT = new MarkerAnchor(1f, 0.5f);
    static final MarkerAnchor ANCHOR_BOTTOM = new MarkerAnchor(0.5f, 0.5f);
    static final MarkerAnchor ANCHOR_BOTTOM_LEFT = new MarkerAnchor(0f, 1f);
    static final MarkerAnchor ANCHOR_BOTTOM_RIGHT = new MarkerAnchor(1f, 1f);
    static final MarkerAnchor ANCHOR_LEFT = new MarkerAnchor(0f, 0.5f);

    public void get(LatLng currentLocation , LatLng location, GoogleMap mMap){
        LatLng temp = null;
        VisibleRegion visibleRegion = mMap.getProjection().getVisibleRegion();
        double nLat, nLng;

        markerAnchor = new MarkerAnchor(0f,0f);
